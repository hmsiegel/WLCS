...
{
    /// <summary>
    /// Gets the identity provider ID from the currently authenticated user.
    /// </summary>
    /// <param name="claimsPrincipal">The claims principal.</param>
    /// <returns>The identity provider ID of the currently authenticated user if it exists, or an empty string.</returns>
