...
namespace WLCS.Modules.Athletes.Infrastructure.Outbox;
    ...
    where TDomainEvent : IDomainEvent
{
    ...
    OutboxMessageConsumer outBoxMessageConsumer)
  {
    const string sql =
      ...
      SELECT EXISTS(
        SELECT 1
        FROM athletes.outbox_message_consumers
    ...
    OutboxMessageConsumer outBoxMessageConsumer)
  {
    const string sql =
      """
      INSERT INTO athletes.outbox_message_consumers(outbox_message_id, name)
