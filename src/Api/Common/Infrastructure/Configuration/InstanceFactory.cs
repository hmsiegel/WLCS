...
internal static class InstanceFactory
{
    ...
    /// <param name="assemblies">The assemblies to scan fo rthe isntance of the specified type.</param>
    /// <returns>The enumerable collection of the instance of the specified type defined in the specified assemblies.</returns>
