...
public static class LoggerExtensions
{
    ...
    public static void LogError(this ILogger logger, IDomainEvent domainEvent, Error error) =>
        logger.LogError("Error while processing domain event {DomainEvent}: {Error}", domainEvent.Id, error);
    ...
    public static void LogError(this ILogger logger, IIntegrationEvent integrationEvent, Error error) =>
        logger.LogError("Error while processing integration event {DomainEvent}: {Error}", integrationEvent.Id, error);
}
